...
console.log("Team1 score = 3");
console.log("Team2 score = 4");
decider(3, 4);

console.log("Team1 score = 5");
console.log("Team2 score = 1");
decider(5, 1);

console.log("Team1 score = 2");
console.log("Team2 score = 2");
decider(2, 2);
...
console.log("\n");
console.log("5. Alert, Prompt, Confirm");
